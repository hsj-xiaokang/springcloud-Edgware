...
public class RestTemplateConfigurer {
	 ...
	 * 日志记录
	 */
	private final static Logger logger = LoggerFactory.getLogger(RestTemplateConfigurer.class);
	...
	@Bean
	@Primary
	@LoadBalanced // 启用Robin客户端负载均衡
	public RestTemplate restTemplate() throws KeyManagementException, KeyStoreException, NoSuchAlgorithmException {
		logger.info(StringUtils.center("RestTemplate Init", LoggerConstant.FILLER_LENGTH_MIDDLE,
				LoggerConstant.FILLER_STRING));
		return new RestTemplate(new HttpComponentsClientHttpRequestFactory(acceptsUntrustedCertsHttpClient()));
	}
}